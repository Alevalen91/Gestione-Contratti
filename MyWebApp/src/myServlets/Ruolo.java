...
public class Ruolo extends HttpServlet {
	...
	private Connection getConn() throws ClassNotFoundException, SQLException {
		...
		conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/gestionale2?user=root&password=Password01@");
		return conn;
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getHeader("content-type").equals("application/x-www-form-urlencoded")) {
			// Qui eseguirò le operazioni qual'ora la request
			...
			try {
				...
				//				Se ci fossero più elementi sull'array json
